...
export const AboutSection = () => {
  ...
  return (
    <section className='py-20 lg:py-28  container'>
      <SectionHeader
      ...
      <div className='mt-20 flex flex-col gap-8'>
        <div className='grid grid-cols-1 gap-y-8 md:gap-x-8 md:grid-cols-5 lg:grid-cols-3'>
          {/* MY READS CARD */}
          <Card className='md:col-span-2 lg:col-span-1 h-[320px]'>
            <CardHeader
              title='My Reads'
              description='Explore the books shaping my perspectives.'
            />
            <div className='w-40 mx-auto mt-2 md:mt-0 hover:-mt-4 transition-all duration-300'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-y-8 md:gap-x-8'>
          {/* HOBBIES CARD */}
          ...
          {/* MAP CARD */}
          <Card className='h-[320px] relative p-0 flex items-center justify-center md:col-span-2 lg:col-span-1'>
            <Image
              src={mapImage}
              alt='Map'
