      ...
      <div className='container'>
        ...
        <div className='flex flex-col mt-10 md:mt-20 gap-20'>
          {portfolioProjects.map((project) => (
            ...
            <div
              key={project.title}
              className='bg-gray-800 rounded-3xl relative z-0 after:z-10 overflow-hidden after:content-[""] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-3xl after:outline-white/20 pt-8 px-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20  after:pointer-events-none'
            >
              <div
